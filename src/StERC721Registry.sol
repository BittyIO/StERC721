...
contract StERC721Registry is OwnableUpgradeable, ReentrancyGuardUpgradeable, IStERC721Registry {
    ...
    function createStERC721(address erc721, address stERC721Impl) external override returns (address) {
    ...
    function upgradeStERC721(address erc721, address stERC721Impl, bytes calldata encodedCallData) external override {
